...
const steps: TutorialStep[] = [
  ...
  {
    id: 'power',
    title: 'Ajuste a forca',
    body: 'Use a barra de forca no rodape. Arraste ate a potencia desejada e solte para bater.',
  ...
  },
  {
    ...
    body: 'Quando soltar a barra, o taco avanca rapido e a fisica assume a jogada.',
    selector: '.mobile-power-footer',
    placement: 'bottom',
    icon: MousePointer2,
  },
